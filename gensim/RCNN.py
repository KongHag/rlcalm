...
if KAGGLE_KERNEL :
    ...
    CLASSIFIER_MODEL_FILE = this_folder_path + '/../input/weights/' + 'RCNN_doc2Vec_weights.h5'
    SUBMISSION_FILE_NAME = '../input/submission/submission_RCNN.csv'
else:
    ...
    CLASSIFIER_MODEL_FILE = this_folder_path + 'Weights/' + 'RCNN_doc2Vec_weights.h5'
    SUBMISSION_FILE_NAME = this_folder_path + 'submission_RCNN.csv'
...
if CLASSIFICATION_TRAINING:
    ...
    model = get_rcnn(nb_words=vocab_size, embedding_dim=600, embedding_matrix=embedding_matrix, max_sequence_length=maxlen, out_size=1) 
