...
DATE : 12-05-2019
DESCRIPTION :
THIS MODULE BUILDS A MODEL WITH ITS OWN EMBEDDING USING DOC2VEC AND A CNN 
...
if KAGGLE_KERNEL :
    ...
    print(os.listdir("../input/submission"))
    ...
    CLASSIFIER_MODEL_FILE = this_folder_path + '/../input/weights/' + 'bi_GRU_doc2Vec_weights.h5'
    SUBMISSION_FILE_NAME = '../input/submission/submission_bi_GRU.csv'
else:
    ...
    CLASSIFIER_MODEL_FILE = this_folder_path + 'Weights/' + 'bi_GRU_doc2Vec_weights.h5'
    SUBMISSION_FILE_NAME = this_folder_path + 'submission_bi_GRU.csv'
...
if CLASSIFICATION_TRAINING:
    ...
    model = get_dropout_bi_gru(nb_words=vocab_size, embedding_dim=600, embedding_matrix=embedding_matrix, max_sequence_length=maxlen, out_size=1) 
