...
if KAGGLE_KERNEL :
    ...
    CLASSIFIER_MODEL_FILE = this_folder_path + '/../input/weights/' + 'Avg_RNN_doc2Vec_weights.h5'
    SUBMISSION_FILE_NAME = '../input/submission/submission_Avg_RNN.csv'
else:
    ...
    CLASSIFIER_MODEL_FILE = this_folder_path + 'Weights/' + 'Avg_RNN_doc2Vec_weights.h5'
    SUBMISSION_FILE_NAME = this_folder_path + 'submission_Avg_RNN.csv'
...
if CLASSIFICATION_TRAINING:
    ...
    model = get_av_rnn(nb_words=vocab_size, embedding_dim=600, embedding_matrix=embedding_matrix, max_sequence_length=maxlen, out_size=1) 
